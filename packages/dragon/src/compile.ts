...
import type { DslActor, DslDocument, DslLane, DslStep, DslEventBinding, DslValue, PresetType } from "./types";
// 図種ごとの組み立てを分けた先 (#2030)。 共有の小道具から順に出している。
// どれも他の file を取り込まない葉なので、図種ごとの file と両方から呼んでも輪にならない
import { 図表の大きさ } from "./compile/chart-fields";
...
import { lookupPartRaw } from "./compile/parts-lookup";
...
import type { CdlDiagram, CdlEdge, FormulaAst, LaidDiagram, RowMark } from "@cardenelabs/cdl";
import { FSM_ACTION_MARK, diagram, layout, applyDerivedValues, parseFormula, extractIdentifiers, inputDefaultValue } from "@cardenelabs/cdl";
...
import { MAX_INPUT_ELEMENTS, countDiagramElements, countDocElements, describeOversize } from "./input-size";
import { orderByDependency, resolveRelativePos, type AnchorBox, type RelativeDirection } from "./relative-pos";
