/**
 * Editor SAMPLES 15 diagram の cdl validate check (CAR-1659)。
 *
 ...
 * 特定する。 fix 後は「全 15 sample が validate pass」 assert で regression 検知。
 *
...
describe("editor SAMPLES 15 diagram validate", () => {
  it("SAMPLES count が 15 (期待値、 CdlEditor.tsx 側と drift しない SSOT check)", () => {
