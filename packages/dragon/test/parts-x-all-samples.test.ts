/**
 * 全 80 parts × 全 15 EDITOR_SAMPLES × 究極 cross matrix (iter19、 2026-07-19)。
 *
 ...
 *
 * 12 × 80 = 1200 test で「parts が任意の実 sample に inject 可能」 の invariant を保証。
...
describe("iter19: 全 80 parts × 全 15 EDITOR_SAMPLES cross matrix (1200 test)", () => {
  it(`parts count >= 60 + samples count = 15`, () => {
