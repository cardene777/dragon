/**
 * 全 80 parts × 全 24 EDITOR_SAMPLES × 究極 cross matrix (iter19、 2026-07-19)。
 *
...
describe("iter19: 全 80 parts × 全 24 EDITOR_SAMPLES cross matrix (1520 test)", () => {
  it(`parts count >= 60 + samples count = 24`, () => {
