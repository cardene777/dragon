...
export const 受け入れた一覧: readonly 受け入れた群[] = [
  ...
  },
  {
    ...
    理由:
      ...
      " 拡大 の器でも境を割る (#2011)。" +
      " 部品を基準にして箱を置く見本は、部品 2 つの間に箱を 1 つ挟んで横に 3 つ並べるため" +
      " 幅が 1649 になり、一覧 の器 (幅 874px) で 0.530 倍に縮む (#2039)。" +
      " 届くのは幅 1602 以下で、残る 47 を削る先は部品 2 つ (state-indicator と thermometer) の" +
      " 実寸しかない。 縦に積むと部品 2 つ分で 一覧 の台に描ける高さ (900) を超える",
    図: [
      ...
      { id: "設備の稼働の右に受付を置き-受付の右に乾燥炉の温度を置く", 器: ["一覧"] },
    ],
  },
];
