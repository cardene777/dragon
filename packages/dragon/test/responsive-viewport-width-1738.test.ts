 ...
 * 縦が決める**。 実測 (画面 1440 × 900、拡大表示)。
 *
 * | 図 | viewBox | 幅から出す見込み | 画面での実測 |
 * |---|---|---|---|
 * | `多対多が-2-組-8-表-8-関係` | 1255×1700 | 19.3px | 8.2px |
 * | `er-complex-demo` | 2190×2904 | 11.1px | 4.8px |
 * | `swim-demo` | 1848×285 | 13.1px | 13.7px |
 *
 * ## 数を書き写さない
 *
