...
const 動かさないと決めた: Record<string, string> = {
  ...
  "節の色-6-種-題も書く": "節の色の見本。 題を書いても色が残ることを並べて見せる",
  ...
  // 線の役目の見本 (#2141)。 見せたいのは線の色の違いで、値を動かすとそちらに目が行く
  線の役目を書かない: "線の役目の見本。 見せたいのは線の色",
  通り道の線に役目を書く: "線の役目の見本。 同上",
  // 矢印の飾りの見本 (#2394)。 見せたいのは色味と線の種類と端の字で、値を動かすとそちらに目が行く
  縦列を書いて矢印を飾る: "矢印の飾りの見本。 見せたいのは線の色と引き方と端の字",
  縦列を書かずに矢印を飾る: "矢印の飾りの見本。 同じ飾りが鎖の形でも出ることを見せる",
  ...
  フローの並ぶ向きを書かない: "フローの並ぶ向きの見本。 見せたいのは箱の並ぶ向き",
  フローを縦に積む: "フローの並ぶ向きの見本。 同上",
  フローを横に並べる: "フローの並ぶ向きの見本。 同上",
  フローの矢印を書いた端のとおりに繋ぐ: "フローの並ぶ向きの見本。 見せたいのは矢印を引く端",
  状態の始まりと終わりを書かない: "状態の始まりと終わりの見本。 見せたいのはどの箱に札が付くか",
  状態の始まりと終わりを書く: "状態の始まりと終わりの見本。 同上",
  状態の始まりと終わりを段を分けて書く: "同じ内容を段を分けて書いた見本 (#2346)。 同上",
