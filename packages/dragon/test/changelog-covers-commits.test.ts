...
const 利用者から見えない: Record<string, string> = {
  ...
  "1458": "版を切る commit そのもの。 変更履歴の更新が中身",
  "1474": "実画面の検査を足しただけ。 記法にも描かれ方にも触れない",
  "1476": "実画面の検査を全図種へ広げただけ。 記法にも描かれ方にも触れない",
  "1477": "順序図が板になったことに実画面の検査を追随させただけ。 記法にも描かれ方にも触れない",
  "1479": "実画面の検査の記録を実物に合わせただけ。 記法にも描かれ方にも触れない",
  "1482": "名札の検査を移すか retire するかを決めただけ。 記法にも描かれ方にも触れない",
  "1486": "実画面の検査の測り方を直しただけ。 記法にも描かれ方にも触れない",
};
