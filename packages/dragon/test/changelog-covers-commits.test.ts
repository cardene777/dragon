...
const 利用者から見えない: Record<string, string> = {
  ...
  //
  // **版を切る時に、前の版の範囲に落ちた番号をここから外す**。 `0.10.0` を切った時点で
  // 範囲が `v0.9.0..HEAD` に縮み、それより前の 7 件 (#1279 / #1282 / #1284 / #1285 /
  // #1288 / #1290 / #1316) が範囲の外に出たため外した
  "1321": "版を切る commit そのもの。 変更履歴の更新が中身",
};
