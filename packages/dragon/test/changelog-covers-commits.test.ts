...
const 利用者から見えない: Record<string, string> = {
  ...
  // 切る commit) が範囲の外に出たため外した
  "1516": "検査を足しただけ。 記法も描き方も動かないので、使う側に見える変化が無い",
  "1518": "意匠帳の場と、それを作る skill / script を足した。 published package の中身は動かない",
  "1520": "意匠帳の吸い出しに色の規則を含めた。 図そのものの色は動かない",
  "1522": "見本の図の見た目を直した。 記法も engine も動かないので、使う側の書き方は変わらない",
  "1524": "意匠帳の頁に図を大きく見る覆いを足した。 published package の中身は動かない",
  "1526": "覆いの高さを図に合わせた。 published package の中身は動かない",
  "1529": "意匠帳 skill の手順に artifact の扱いを書いた。 記法も engine も動かない",
  "1555": "検査を足しただけ。 記法も描き方も動かないので、使う側に見える変化が無い",
  "1559": "検査を足し、辺の役目の読み手が定数を見る形にした。 受ける語は変わらない",
  "1561": "向きの語を定数に切り出し、検査の逃げ道を外した。 受ける語は変わらない",
  "1563": "検査 1 file の中で宣言を束ねただけ。 記法も描き方も動かない",
  "1565": "版を切る commit そのもの。 変更履歴の更新が中身",
};
