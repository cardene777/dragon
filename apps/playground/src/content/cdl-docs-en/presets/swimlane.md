...
phases:
  - { id: call, duration_ms: 1500, title: call, body: "Alice calls transfer.", activates: [alice, fn, alice-fn] }
  - { id: emit, duration_ms: 1500, title: emit, body: "Notify Bob.",           activates: [fn, bob, fn-bob] }
...
const transfer = swim
  ...
  .phase("call", { duration: 1500, title: "call", body: "Alice calls transfer." },
    (p) => p.activate("alice", "fn", "alice-fn"))
  .phase("emit", { duration: 1500, title: "emit", body: "Notify Bob." },
