...
const 状態違い = [
  ...
  { 設計: "03c カタログの分類 コード", 元: "03 カタログの分類" },
] as const;
...
const 共通部品: readonly string[] = [
  "C / TopBar",
  "C / Buttons",
  // 一覧 / 図 / コード / 頁 が「読み込み中」 「該当なし」 等になった時の姿を並べたカタログ。
  // 画面ではないので明暗の対を持たず、 どれか 1 つの画面に属しもしない
  "C / States",
  // 絞り込み欄の 3 状態 (通常 / 入力中 / 入力あり) を並べたカタログ (#1236)
  "C / Search 見本",
];
