...
const 宣言: ReadonlyMap<string, string> = new Map([
  ...
  [
    "preset/gantt",
    "図が持つ文字そのものが小さく、実寸 (100%) まで拡げても 7.6px にしかならない。" +
      " 下限は小さすぎるのを止める床で、実物より大きく見せる仕掛けではない (`READABLE_MAX_SCALE`)。" +
      " 直すなら図の側の文字を大きくする話で、記法の package (別 repo) が持つ",
  ],
  [
    "preset/funnel",
    "同じ理由で実寸でも 7.9px。 図の側の文字が小さい",
  ],
]);
