...
export const PRESETS: PresetMetadata[] = [
  ...
  { id: "funnel", slug: "funnel", eyebrow: "数の図 / 絞り込み", subtitle: "訪問から登録・試用・有料の契約へ段階が進むにつれて、人数が絞られていく様子を示す図。", tags: ["段階", "離脱"], diagram: presetFunnel },
  { id: "quadrant", slug: "quadrant", eyebrow: "比較の図 / 位置づけ", subtitle: "労力と価値の 2 軸で項目を 4 つの枠に振り分け、どこから手を付けるかを決める優先度の図。", tags: ["4 象限", "優先度"], diagram: presetQuadrant },
