...
export const PRESETS: PresetMetadata[] = [
  ...
  { id: "er", slug: "er", eyebrow: "ER / DB SCHEMA", subtitle: "3 表 × 3 関係。 主キーと外部キー、識別する関係としない関係、自己参照を示す ER 図。", tags: ["entity", "relation"], diagram: presetEr },
  ...
  { id: "classDiagram", slug: "class", eyebrow: "CLASS / UML", subtitle: "7 クラス × 6 関係。 継承・実装・集約・コンポジション・関連・依存の 6 種を 1 枚で示す UML クラス図。", tags: ["class", "UML"], diagram: presetClassDiagram },
  { id: "classComplex", slug: "class-complex", eyebrow: "CLASS / UML", subtitle: "12 クラス × 14 関係。 抽象クラスとインターフェース、6 種の関係を含む決済の仕組み。", tags: ["12 classes", "6 relations"], diagram: presetClassComplex },
