...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    label: "実用例",
    eyebrow: "現場でよく出る要件",
    desc: "本番でよく議論される要件をそのまま図にした集合。 認証の流れ / データ操作 / 非同期処理などを動く形でコピペして、 会議での議論の起点として使う。",
    items: ["API・認証", "データ操作", "画面・フォーム", "非同期", "運用"],
    cluster: "basic",
  },
  {
    slug: "patterns",
    label: "組み方の型",
    eyebrow: "繰り返し出る組み方",
    desc: "図の組立てで繰返し出る汎用構造の型。 「今描きたいのは直結か分岐かループか」 を先に選ぶと、 描き方を毎回考えなくて済む。 部品を何に配線するかの参照書。",
  ...
  },
  {
    ...
    label: "テキスト記法",
    eyebrow: "箇条書きで図を書く",
    desc: "TypeScript を書かず箇条書きだけで図を書く経路。 覚え書きと同じ感覚の 5 つの塊で済むので、 メモから起こしたい / 書き慣れていない人にも書かせたい時の入口。",
  ...
  },
  {
    ...
    label: "動く図",
    eyebrow: "時間軸の物語",
    desc: "段で状態が推移 / 数値が滑らか補間 / 即時切替 / バッジで段の題を出す の 4 要素を組合せて時間軸の物語を作る。 静止図では伝わらない「変化」 「順序」 を語りたい時に。",
    items: ["補間", "切替", "バッジ", "併用"],
    cluster: "extended",
  },
  {
  ...
  },
  {
    ...
    label: "部品",
    eyebrow: "合成用の小さな部品",
    desc: "リッチな図を組立てる時に「これ使いたい」 と選ぶ小部品の見本市。 バケット / ゲージ / インジケーター / タイムライン等、 1 つで 1 概念を体現する完成物、 動く図の一覧の側で複数の部品を合成して物語を作る。",
