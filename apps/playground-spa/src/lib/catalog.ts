...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    label: "基本要素",
    eyebrow: "cdl の最小構成",
    desc: "dragon DSL の最小構成要素 (lane / node / edge / phase / state) と、 業務ドメイン別 node kind を確認する場。 「この kind は何を描くか」 を学習する起点、 部品を選ぶ前の予備知識に。",
  ...
  },
  {
    ...
    label: "動く図",
    eyebrow: "時間軸の物語",
    desc: "phase で状態が推移 / 数値が滑らか補間 / 即時切替 / badge でシーン表示 の 4 要素を組合せて時間軸の物語を作る。 静止図では伝わらない「変化」 「順序」 を語りたい時に。",
    items: ["補間", "切替", "バッジ", "併用"],
    cluster: "extended",
  },
  {
