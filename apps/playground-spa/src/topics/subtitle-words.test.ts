 ...
 * 延べなら 1 語足すたびに 1 増える。
 *
 * **上がることもある** (#1863)。 記法の綴りの照合が型の説明文の中の作り話の名前
 * (`User` / `Browser` / `Admin` など 151 語) まで通していたので、直した分だけ実数が増えた
 * (語 395 → 423、延べ 556 → 589)。 いままで隠れていた分が見えるようになっただけで、
 * 開く作業 (#1829) の母数が正確になる向き。
 */
const 天井 = { 説明: 122, 語: 423, 延べ: 589 };
