...
export const kindActor = diagram("kind-actor", { topic: "kind: actor (外部主体)" })
  ...
  .phase("p2", { duration: 1800, title: "actor が動く", body: "箱は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("a").tween("v", 0, 42).badge("動く"))
  .build();

export const kindFunction = diagram("kind-function", { topic: "kind: function (関数呼び出し)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("fn", { lane: "l", stack: 0, kind: "function", value: "{v} 呼/秒", title: "handler(req)", eyebrow: "関数呼び出し", subtitle: "-> Result<Order, ValidationError>" })
  ...
  .phase("p2", { duration: 1800, title: "function が動く", body: "箱は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("fn").tween("v", 0, 96).badge("動く"))
  .build();

export const kindStorage = diagram("kind-storage", { topic: "kind: storage (保存データ)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "storage", value: "{v} 行", title: "users", eyebrow: "保存データ", rows: ["id: PK", "email: text"] })
  .phase("p", { duration: 1500, title: "storage", body: "DB の table。 rows で複数 column 表示。" }, (p: PhaseBuilder) => p.activate("s").badge("active"))
  .phase("p2", { duration: 1800, title: "storage が動く", body: "箱は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 12400).badge("動く"))
  .build();

export const kindEvent = diagram("kind-event", { topic: "kind: event (イベントログ)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("e", { lane: "l", stack: 0, kind: "event", value: "{v} 件", title: "OrderCreated", eyebrow: "イベント", subtitle: "(orderId, userId, total)" })
  .phase("p", { duration: 1500, title: "event", body: "emit された event。 event bus / log が読む。" }, (p: PhaseBuilder) => p.activate("e").badge("active"))
  .phase("p2", { duration: 1800, title: "event が動く", body: "箱は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("e").tween("v", 0, 318).badge("動く"))
  .build();

export const kindCard = diagram("kind-card", { topic: "kind: card (汎用情報)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "card", value: "{v}%", title: "備考", eyebrow: "汎用カード", subtitle: "汎用の説明カード" })
  .phase("p", { duration: 1500, title: "card", body: "kind に当てはまらない補足情報。" }, (p: PhaseBuilder) => p.activate("c").badge("active"))
  .phase("p2", { duration: 1800, title: "card が動く", body: "箱は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 100).badge("動く"))
  .build();
...
export const shapeFile = diagram("shape-file", { structuredData: "exclude", topic: "shape: file (ドッグイア rect、 ファイル / document 表現)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("f", { lane: "l", stack: 0, kind: "shape-file", value: "{v} MB", title: "report.pdf", eyebrow: "file", subtitle: "PDF 1.2 MB", w: 272 })
  .phase("p", { duration: 1500, title: "file", body: "右上がドッグイアで折り返された rect。 ファイル / 文書 / レポート等" }, (p: PhaseBuilder) => p.activate("f").badge("shape"))
  .phase("p2", { duration: 1800, title: "file が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("f").tween("v", 0, 1.2).badge("動く"))
  .build();

export const shapeFolder = diagram("shape-folder", { structuredData: "exclude", topic: "shape: folder (tab 付き rect、 フォルダ / パッケージ)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("f", { lane: "l", stack: 0, kind: "shape-folder", value: "{v} files", title: "src/", eyebrow: "folder", subtitle: "24 files" })
  .phase("p", { duration: 1500, title: "folder", body: "上端に tab のある rect。 ディレクトリ / package / モジュール群等" }, (p: PhaseBuilder) => p.activate("f").badge("shape"))
  .phase("p2", { duration: 1800, title: "folder が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("f").tween("v", 0, 24).badge("動く"))
  .build();

export const shapeCloud = diagram("shape-cloud", { structuredData: "exclude", topic: "shape: cloud (5 円 合成、 クラウド / SaaS 表現)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-cloud", value: "{v} 台", title: "AWS", eyebrow: "cloud" })
  .phase("p", { duration: 1500, title: "cloud", body: "5 円 合成の cloud shape。 AWS / GCP / SaaS / 外部 API 等" }, (p: PhaseBuilder) => p.activate("c").badge("shape"))
  .phase("p2", { duration: 1800, title: "cloud が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 18).badge("動く"))
  .build();

export const shapeCylinder = diagram("shape-cylinder", { structuredData: "exclude", topic: "shape: cylinder (円柱、 DB / storage 表現)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-cylinder", value: "{v} GB", title: "PostgreSQL", eyebrow: "database", subtitle: "500 GB SSD", w: 272 })
  ...
  .phase("p2", { duration: 1800, title: "cylinder が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 840).badge("動く"))
  .build();

export const shapeHexagon = diagram("shape-hexagon", { structuredData: "exclude", topic: "shape: hexagon (六角形、 component / service)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("h", { lane: "l", stack: 0, kind: "shape-hexagon", value: "{v} 面", title: "AuthService", eyebrow: "component", w: 294 })
  .phase("p", { duration: 1500, title: "hexagon", body: "六角形。 microservice / ドメインコンポーネント / モジュール表現" }, (p: PhaseBuilder) => p.activate("h").badge("shape"))
  .phase("p2", { duration: 1800, title: "hexagon が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("h").tween("v", 0, 6).badge("動く"))
  .build();

export const shapeDiamond = diagram("shape-diamond", { structuredData: "exclude", topic: "shape: diamond (ひし形、 decision / 判定)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("d", { lane: "l", stack: 0, kind: "shape-diamond", value: "{v}% 真", title: "valid?", eyebrow: "decision" })
  .phase("p", { duration: 1500, title: "diamond", body: "ひし形。 判定分岐 / choice / gateway 表現" }, (p: PhaseBuilder) => p.activate("d").badge("shape"))
  .phase("p2", { duration: 1800, title: "diamond が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("d").tween("v", 0, 100).badge("動く"))
  .build();

export const shapeStack = diagram("shape-stack", { structuredData: "exclude", topic: "shape: stack (重ね rect、 layer / history)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-stack", value: "{v} 層", title: "v3.2.0", eyebrow: "release" })
  .phase("p", { duration: 1500, title: "stack", body: "重なった 3 段の rect。 バージョン履歴 / layer / snapshot 群等" }, (p: PhaseBuilder) => p.activate("s").badge("shape"))
  .phase("p2", { duration: 1800, title: "stack が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 5).badge("動く"))
  .build();

export const shapePerson = diagram("shape-person", { structuredData: "exclude", topic: "shape: person (人型 figure、 actor / user 表現)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("p", { lane: "l", stack: 0, kind: "shape-person", value: "{v} 人", title: "エンドユーザ", eyebrow: "actor" })
  ...
  .phase("p2", { duration: 1800, title: "person が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("p").tween("v", 0, 1).badge("動く"))
  .build();
...
export const shapeWindow = diagram("shape-window", { structuredData: "exclude", topic: "shape: window (GUI アプリ、 traffic lights + body)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("w", { lane: "l", stack: 0, kind: "shape-window", value: "{v} 画面", title: "ダッシュボード", eyebrow: "window", subtitle: "GUI アプリ" })
  ...
  .phase("p2", { duration: 1800, title: "window が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("w").tween("v", 0, 3).badge("動く"))
  .build();

export const shapeTerminal = diagram("shape-terminal", { structuredData: "exclude", topic: "shape: terminal (CLI shell、 mac bar + prompt)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("t", { lane: "l", stack: 0, kind: "shape-terminal", value: "{v} 行", title: "zsh", eyebrow: "terminal", subtitle: "CLI shell" })
  ...
  .phase("p2", { duration: 1800, title: "terminal が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("t").tween("v", 0, 42).badge("動く"))
  .build();
...
export const shapeCodeBlock = diagram("shape-code-block", { structuredData: "exclude", topic: "shape: code-block (snippet、 editor tab + 4 syntax lines)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-code-block", value: "{v} 行", title: "utils.ts", eyebrow: "code", subtitle: "3 line snippet" })
  ...
  .phase("p2", { duration: 1800, title: "code-block が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 128).badge("動く"))
  .build();
...
export const shapeKanbanCard = diagram("shape-kanban-card", { structuredData: "exclude", topic: "shape: kanban-card (ticket + priority + tags)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("k", { lane: "l", stack: 0, kind: "shape-kanban-card", value: "{v} 枚", title: "CAR-1111", eyebrow: "in progress", subtitle: "shape-driven kind" })
  ...
  .phase("p2", { duration: 1800, title: "kanban-card が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("k").tween("v", 0, 7).badge("動く"))
  .build();
...
export const shapeMessageBubble = diagram("shape-message-bubble", { structuredData: "exclude", topic: "shape: message-bubble (吹き出し、 rounded rect + tail)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("m", { lane: "l", stack: 0, kind: "shape-message-bubble", value: "{v} 通", title: "了解しました", eyebrow: "message" })
  ...
  .phase("p2", { duration: 1800, title: "message-bubble が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("m").tween("v", 0, 36).badge("動く"))
  .build();

export const shapeGear = diagram("shape-gear", { structuredData: "exclude", topic: "shape: gear (歯車、 設定 / 処理エンジン)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("g", { lane: "l", stack: 0, kind: "shape-gear", value: "{v} rpm", title: "Settings", eyebrow: "config", subtitle: "設定 / process engine" })
  ...
  .phase("p2", { duration: 1800, title: "gear が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("g").tween("v", 0, 1450).badge("動く"))
  .build();
...
export const shapeServerRack = diagram("shape-server-rack", { structuredData: "exclude", topic: "shape: server-rack (19 inch rack、 物理サーバ)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-server-rack", value: "{v} U", title: "web-01", eyebrow: "server", subtitle: "3 U rack mount" })
  ...
  .phase("p2", { duration: 1800, title: "server-rack が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 24).badge("動く"))
  .build();
...
export const shapeNetworkNode = diagram("shape-network-node", { structuredData: "exclude", topic: "shape: network-node (network hub、 router / switch)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("n", { lane: "l", stack: 0, kind: "shape-network-node", value: "{v} Mbps", title: "core-router", eyebrow: "network", subtitle: "L3 gateway" })
  ...
  .phase("p2", { duration: 1800, title: "network-node が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("n").tween("v", 0, 320).badge("動く"))
  .build();

export const shapeMobileDevice = diagram("shape-mobile-device", { structuredData: "exclude", topic: "shape: mobile-device (スマホ、 モバイル端末)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("m", { lane: "l", stack: 0, kind: "shape-mobile-device", value: "{v}% 電池", title: "iPhone", eyebrow: "mobile", subtitle: "iOS client" })
  ...
  .phase("p2", { duration: 1800, title: "mobile-device が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("m").tween("v", 0, 78).badge("動く"))
  .build();

export const shapeIotSensor = diagram("shape-iot-sensor", { structuredData: "exclude", topic: "shape: iot-sensor (IoT beacon、 電波発信)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-iot-sensor", value: "{v} ℃", title: "温度センサー", eyebrow: "iot", subtitle: "BLE beacon" })
  ...
  .phase("p2", { duration: 1800, title: "iot-sensor が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 26.4).badge("動く"))
  .build();

export const shapeRobotArm = diagram("shape-robot-arm", { structuredData: "exclude", topic: "shape: robot-arm (ロボアーム、 産業機器)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("r", { lane: "l", stack: 0, kind: "shape-robot-arm", value: "{v} 度", title: "組立ライン", eyebrow: "robot", subtitle: "6-axis arm" })
  ...
  .phase("p2", { duration: 1800, title: "robot-arm が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("r").tween("v", 0, 180).badge("動く"))
  .build();

export const shapeSatellite = diagram("shape-satellite", { structuredData: "exclude", topic: "shape: satellite (人工衛星、 エッジ通信)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-satellite", value: "{v} km", title: "Starlink", eyebrow: "satellite", subtitle: "LEO 通信衛星" })
  ...
  .phase("p2", { duration: 1800, title: "satellite が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 550).badge("動く"))
  .build();
...
export const shapeSmartContract = diagram("shape-smart-contract", { structuredData: "exclude", topic: "shape: smart-contract (契約書 + 歯車 = 自動実行)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-smart-contract", value: "{v} 呼出", title: "Vault.sol", eyebrow: "contract", subtitle: "0.8.24" })
  ...
  .phase("p2", { duration: 1800, title: "smart-contract が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 1280).badge("動く"))
  .build();
...
export const shapeBlockchainBlock = diagram("shape-blockchain-block", { structuredData: "exclude", topic: "shape: blockchain-block (連結 3 block + hash pointer)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("b", { lane: "l", stack: 0, kind: "shape-blockchain-block", value: "{v} gas", title: "Block #421", eyebrow: "chain", subtitle: "0xaf31c9d2..." })
  ...
  .phase("p2", { duration: 1800, title: "blockchain-block が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("b").tween("v", 0, 21000).badge("動く"))
  .build();
...
export const shapeRpcNode = diagram("shape-rpc-node", { structuredData: "exclude", topic: "shape: rpc-node (JSON-RPC node + 6 peers + sync bar)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("r", { lane: "l", stack: 0, kind: "shape-rpc-node", value: "{v} ms", title: "Alchemy", eyebrow: "rpc", subtitle: "mainnet endpoint" })
  ...
  .phase("p2", { duration: 1800, title: "rpc-node が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("r").tween("v", 0, 96).badge("動く"))
  .build();

export const shapeWallet = diagram("shape-wallet", { structuredData: "exclude", topic: "shape: wallet (財布 + coin + balance display)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("w", { lane: "l", stack: 0, kind: "shape-wallet", value: "{v} ETH", title: "MetaMask", eyebrow: "wallet", subtitle: "EOA / EIP-4337" })
  ...
  .phase("p2", { duration: 1800, title: "wallet が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("w").tween("v", 0, 3.42).badge("動く"))
  .build();

export const shapeNft = diagram("shape-nft", { structuredData: "exclude", topic: "shape: nft (額縁 + polygonal art + verified badge)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("n", { lane: "l", stack: 0, kind: "shape-nft", value: "{v} 点", title: "CryptoPunk", eyebrow: "nft", subtitle: "ERC-721 #1024", w: 272 })
  ...
  .phase("p2", { duration: 1800, title: "nft が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("n").tween("v", 0, 1).badge("動く"))
  .build();

export const shapeToken = diagram("shape-token", { structuredData: "exclude", topic: "shape: token (硬貨、 fungible currency)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("t", { lane: "l", stack: 0, kind: "shape-token", value: "{v} 枚", title: "ETH", eyebrow: "token", subtitle: "ERC-20 / native" })
  ...
  .phase("p2", { duration: 1800, title: "token が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("t").tween("v", 0, 5200).badge("動く"))
  .build();
...
export const shapeBank = diagram("shape-bank", { structuredData: "exclude", topic: "shape: bank (Greek facade + 4 columns + $)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("b", { lane: "l", stack: 0, kind: "shape-bank", value: "{v} 件/日", title: "みずほ銀行", eyebrow: "bank", subtitle: "都銀" })
  ...
  .phase("p2", { duration: 1800, title: "bank が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("b").tween("v", 0, 1420).badge("動く"))
  .build();
...
export const shapeTrustBank = diagram("shape-trust-bank", { structuredData: "exclude", topic: "shape: trust-bank (bank facade + 冠 crown = 受託の信頼)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("t", { lane: "l", stack: 0, kind: "shape-trust-bank", value: "{v} 億円", title: "三菱 UFJ 信託", eyebrow: "trust-bank", subtitle: "受託業務" })
  .phase("p", { duration: 1500, title: "trust-bank", body: "冠 + facade + Ⓣ letter。 信託銀行 / 受託業務 / 資産管理" }, (p: PhaseBuilder) => p.activate("t").badge("shape"))
  .phase("p2", { duration: 1800, title: "trust-bank が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("t").tween("v", 0, 86).badge("動く"))
  .build();
...
export const shapePaymentProvider = diagram("shape-payment-provider", { structuredData: "exclude", topic: "shape: payment-provider (POS 端末 + screen + keypad)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("p", { lane: "l", stack: 0, kind: "shape-payment-provider", value: "{v} 決済/分", title: "Stripe", eyebrow: "payment", subtitle: "card / QR / 電子マネー" })
  ...
  .phase("p2", { duration: 1800, title: "payment-provider が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("p").tween("v", 0, 640).badge("動く"))
  .build();
...
export const shapeBrokerage = diagram("shape-brokerage", { structuredData: "exclude", topic: "shape: brokerage (証券会社 tower + candle chart + up arrow)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("b", { lane: "l", stack: 0, kind: "shape-brokerage", value: "{v} 注文", title: "野村證券", eyebrow: "brokerage", subtitle: "証券会社" })
  ...
  .phase("p2", { duration: 1800, title: "brokerage が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("b").tween("v", 0, 318).badge("動く"))
  .build();

export const shapeExchange = diagram("shape-exchange", { structuredData: "exclude", topic: "shape: exchange (取引所、 $ ⇄ Ξ swap)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("e", { lane: "l", stack: 0, kind: "shape-exchange", value: "{v} 約定", title: "Coinbase", eyebrow: "exchange", subtitle: "spot / derivatives" })
  .phase("p", { duration: 1500, title: "exchange", body: "2 通貨 coin + 双方向 arrow + rate。 取引所 / DEX / 換金" }, (p: PhaseBuilder) => p.activate("e").badge("shape"))
  .phase("p2", { duration: 1800, title: "exchange が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("e").tween("v", 0, 12400).badge("動く"))
  .build();

export const shapeAtm = diagram("shape-atm", { structuredData: "exclude", topic: "shape: atm (現金自動預払機、 card slot + cash dispenser)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("a", { lane: "l", stack: 0, kind: "shape-atm", value: "{v} 台稼働", title: "ATM", eyebrow: "atm", subtitle: "24 h 稼働" })
  ...
  .phase("p2", { duration: 1800, title: "atm が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("a").tween("v", 0, 94).badge("動く"))
  .build();
...
export const shapeWebsite = diagram("shape-website", { structuredData: "exclude", topic: "shape: website (browser + URL + page layout)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("w", { lane: "l", stack: 0, kind: "shape-website", value: "{v} PV", title: "example.com", eyebrow: "website", subtitle: "corporate site" })
  ...
  .phase("p2", { duration: 1800, title: "website が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("w").tween("v", 0, 2840).badge("動く"))
  .build();
...
export const shapeStorefront = diagram("shape-storefront", { structuredData: "exclude", topic: "shape: storefront (実店舗、 awning + door + windows)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("s", { lane: "l", stack: 0, kind: "shape-storefront", value: "{v} 来店", title: "コンビニ", eyebrow: "store", subtitle: "リアル店舗" })
  ...
  .phase("p2", { duration: 1800, title: "storefront が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("s").tween("v", 0, 46).badge("動く"))
  .build();

export const shapeWarehouse = diagram("shape-warehouse", { structuredData: "exclude", topic: "shape: warehouse (倉庫、 roof + shutter + boxes)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("w", { lane: "l", stack: 0, kind: "shape-warehouse", value: "{v} 在庫", title: "FC1", eyebrow: "warehouse", subtitle: "配送 hub" })
  ...
  .phase("p2", { duration: 1800, title: "warehouse が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("w").tween("v", 0, 1860).badge("動く"))
  .build();
...
export const shapeOnlineShop = diagram("shape-online-shop", { structuredData: "exclude", topic: "shape: online-shop (browser + cart badge + product grid)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("o", { lane: "l", stack: 0, kind: "shape-online-shop", value: "{v} 注文", title: "Amazon", eyebrow: "online-shop", subtitle: "EC site" })
  ...
  .phase("p2", { duration: 1800, title: "online-shop が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("o").tween("v", 0, 228).badge("動く"))
  .build();

export const shapeCdnEdge = diagram("shape-cdn-edge", { structuredData: "exclude", topic: "shape: cdn-edge (地球儀 + 5 edge nodes + arc)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-cdn-edge", value: "{v}% 命中", title: "Cloudflare", eyebrow: "cdn", subtitle: "300+ POP" })
  ...
  .phase("p2", { duration: 1800, title: "cdn-edge が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 99).badge("動く"))
  .build();
...
export const shapeApiGateway = diagram("shape-api-gateway", { structuredData: "exclude", topic: "shape: api-gateway (門柱 + arch + traffic arrow)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("a", { lane: "l", stack: 0, kind: "shape-api-gateway", value: "{v} req/秒", title: "Kong", eyebrow: "gateway", subtitle: "API 管理" })
  ...
  .phase("p2", { duration: 1800, title: "api-gateway が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("a").tween("v", 0, 760).badge("動く"))
  .build();
...
export const shapeAuditor = diagram("shape-auditor", { structuredData: "exclude", topic: "shape: auditor (監査人 + magnifier + check)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("a", { lane: "l", stack: 0, kind: "shape-auditor", value: "{v} 監査", title: "監査法人", eyebrow: "auditor", subtitle: "内部監査" })
  ...
  .phase("p2", { duration: 1800, title: "auditor が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("a").tween("v", 0, 38).badge("動く"))
  .build();

export const shapeRegulator = diagram("shape-regulator", { structuredData: "exclude", topic: "shape: regulator (規制当局 + 冠 crown + 章 badge)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("r", { lane: "l", stack: 0, kind: "shape-regulator", value: "{v} 通達", title: "金融庁", eyebrow: "regulator", subtitle: "監督官庁" })
  .phase("p", { duration: 1500, title: "regulator", body: "人 + crown + 五芒星 badge。 金融庁 / 消費者庁 / 規制当局" }, (p: PhaseBuilder) => p.activate("r").badge("shape"))
  .phase("p2", { duration: 1800, title: "regulator が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("r").tween("v", 0, 12).badge("動く"))
  .build();

export const shapeNotary = diagram("shape-notary", { structuredData: "exclude", topic: "shape: notary (公証人 + 儒学者風 hat + seal 印)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("n", { lane: "l", stack: 0, kind: "shape-notary", value: "{v} 認証", title: "公証役場", eyebrow: "notary", subtitle: "公証人" })
  .phase("p", { duration: 1500, title: "notary", body: "人 + 儒学者風 hat + 紅印。 公証人 / 認証業務 / 書類認証" }, (p: PhaseBuilder) => p.activate("n").badge("shape"))
  .phase("p2", { duration: 1800, title: "notary が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("n").tween("v", 0, 64).badge("動く"))
  .build();

export const shapeLawyer = diagram("shape-lawyer", { structuredData: "exclude", topic: "shape: lawyer (弁護士 + wig + 天秤)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("l", { lane: "l", stack: 0, kind: "shape-lawyer", value: "{v} 案件", title: "顧問弁護士", eyebrow: "lawyer", subtitle: "法律事務所" })
  .phase("p", { duration: 1500, title: "lawyer", body: "人 + 髪 + 正義の天秤 icon。 弁護士 / 法務顧問 / 法律事務所" }, (p: PhaseBuilder) => p.activate("l").badge("shape"))
  .phase("p2", { duration: 1800, title: "lawyer が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("l").tween("v", 0, 9).badge("動く"))
  .build();

export const shapeTrader = diagram("shape-trader", { structuredData: "exclude", topic: "shape: trader (トレーダー + headset + laptop chart)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("t", { lane: "l", stack: 0, kind: "shape-trader", value: "{v} 取引", title: "デイトレーダー", eyebrow: "trader", subtitle: "algorithmic" })
  ...
  .phase("p2", { duration: 1800, title: "trader が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("t").tween("v", 0, 482).badge("動く"))
  .build();
...
export const shapeCustomerService = diagram("shape-customer-service", { structuredData: "exclude", topic: "shape: customer-service (CS + headset + bubble)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-customer-service", value: "{v} 問合せ", title: "サポート担当", eyebrow: "support", subtitle: "24h コンタクト" })
  ...
  .phase("p2", { duration: 1800, title: "customer-service が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 57).badge("動く"))
  .build();
...
export const shapeBlockchain = diagram("shape-blockchain", { structuredData: "exclude", topic: "shape: blockchain (5 block linked chain)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("b", { lane: "l", stack: 0, kind: "shape-blockchain", value: "{v} 高さ", title: "ブロックチェーン", eyebrow: "chain", subtitle: "汎用 5 block" })
  ...
  .phase("p2", { duration: 1800, title: "blockchain が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("b").tween("v", 0, 19400).badge("動く"))
  .build();

export const shapeBitcoinChain = diagram("shape-bitcoin-chain", { structuredData: "exclude", topic: "shape: bitcoin-chain (₿ + PoW + 橙色)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("b", { lane: "l", stack: 0, kind: "shape-bitcoin-chain", value: "{v} 承認", title: "Bitcoin", eyebrow: "bitcoin", subtitle: "PoW mining" })
  ...
  .phase("p2", { duration: 1800, title: "bitcoin-chain が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("b").tween("v", 0, 6).badge("動く"))
  .build();

export const shapeEthereumChain = diagram("shape-ethereum-chain", { structuredData: "exclude", topic: "shape: ethereum-chain (Ξ + PoS + 紫色)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("e", { lane: "l", stack: 0, kind: "shape-ethereum-chain", value: "{v} slot", title: "Ethereum", eyebrow: "ethereum", subtitle: "PoS L1" })
  ...
  .phase("p2", { duration: 1800, title: "ethereum-chain が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("e").tween("v", 0, 32).badge("動く"))
  .build();
...
export const shapeBlockchainNode = diagram("shape-blockchain-node", { structuredData: "exclude", topic: "shape: blockchain-node (P2P hex + 6 peers)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("n", { lane: "l", stack: 0, kind: "shape-blockchain-node", value: "{v} peer", title: "フルノード", eyebrow: "node", subtitle: "P2P peer" })
  ...
  .phase("p2", { duration: 1800, title: "blockchain-node が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("n").tween("v", 0, 128).badge("動く"))
  .build();
...
export const shapeCreditCard = diagram("shape-credit-card", { structuredData: "exclude", topic: "shape: credit-card (chip + magstripe + brand mark)" })
  .lane("l", { x: 0, width: W })
  .state("v", { initial: 0 })
  .node("c", { lane: "l", stack: 0, kind: "shape-credit-card", value: "{v} 決済", title: "クレカ", eyebrow: "card", subtitle: "VISA / Master" })
  ...
  .phase("p2", { duration: 1800, title: "credit-card が動く", body: "形は値を持てる。 値は段の中で連続して動く。" }, (p: PhaseBuilder) => p.activate("c").tween("v", 0, 24).badge("動く"))
  .build();
...
export const sceneCryptoTransfer = diagram("scene-crypto-transfer", { topic: "scene: crypto 送金 (wallet → exchange → chain)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-ethereum-chain", value: "{進み}%", title: "Ethereum", eyebrow: "chain", subtitle: "L1 mainnet" })
  .edge("w", "e", { label: "" })
  .edge("e", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("w").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("w").activate("e").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("w").activate("e").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneLegalNotarization = diagram("scene-legal-notarization", { topic: "scene: 法務 (弁護士 → 公証人 → 登記)" })
  ...
  .node("f", { lane: "l", stack: 2, kind: "shape-file", value: "{進み}%", title: "登記簿", eyebrow: "record", subtitle: "official record" })
  .edge("l1", "n", { label: "" })
  .edge("n", "f", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("l1").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("l1").activate("n").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("l1").activate("n").activate("f").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneBankingFlow = diagram("scene-banking-flow", { topic: "scene: 銀行送金 (ATM → 銀行 → EC)" })
  ...
  .node("s", { lane: "l", stack: 2, kind: "shape-online-shop", value: "{進み}%", title: "Amazon", eyebrow: "shop", subtitle: "EC" })
  .edge("a", "b", { label: "" })
  .edge("b", "s", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("a").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("a").activate("b").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("a").activate("b").activate("s").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneIotOnchain = diagram("scene-iot-onchain", { topic: "scene: IoT オンチェーン (sensor → RPC → contract)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-smart-contract", value: "{進み}%", title: "OracleContract", eyebrow: "contract", subtitle: "Solidity", w: 360 })
  .edge("s", "r", { label: "" })
  .edge("r", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("s").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("s").activate("r").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("s").activate("r").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneAuditFlow = diagram("scene-audit-flow", { topic: "scene: 監査 (auditor → 帳簿 → regulator)" })
  ...
  .node("r", { lane: "l", stack: 2, kind: "shape-regulator", value: "{進み}%", title: "金融庁", eyebrow: "regulator", subtitle: "監督" })
  .edge("a", "f", { label: "" })
  .edge("f", "r", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("a").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("a").activate("f").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("a").activate("f").activate("r").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneStockTrading = diagram("scene-stock-trading", { topic: "scene: 証券取引 (trader → 証券会社 → 取引所)" })
  ...
  .node("e", { lane: "l", stack: 2, kind: "shape-exchange", value: "{進み}%", title: "東証", eyebrow: "exchange", subtitle: "TSE" })
  .edge("t", "b", { label: "" })
  .edge("b", "e", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("t").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("t").activate("b").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("t").activate("b").activate("e").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneSupportFlow = diagram("scene-support-flow", { topic: "scene: 問い合わせ (CS → ticket → 開発)" })
  ...
  .node("d", { lane: "l", stack: 2, kind: "shape-code-block", value: "{進み}%", title: "hotfix.ts", eyebrow: "commit", subtitle: "fix by dev" })
  .edge("c", "k", { label: "" })
  .edge("k", "d", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("c").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("c").activate("k").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("c").activate("k").activate("d").tween("進み", 66, 100).badge("③"))
  .build();
...
export const scenePaymentSettlement = diagram("scene-payment-settlement", { topic: "scene: 決済 (provider → クレカ → 銀行)" })
  ...
  .node("b", { lane: "l", stack: 2, kind: "shape-bank", value: "{進み}%", title: "発行銀行", eyebrow: "issuer", subtitle: "MUFG" })
  .edge("p", "c", { label: "" })
  .edge("c", "b", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("p").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("p").activate("c").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("p").activate("c").activate("b").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneWebInfra = diagram("scene-web-infra", { topic: "scene: web infra (website → CDN → server)" })
  ...
  .node("s", { lane: "l", stack: 2, kind: "shape-server-rack", value: "{進み}%", title: "origin", eyebrow: "server", subtitle: "AWS" })
  .edge("w", "c", { label: "" })
  .edge("c", "s", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("w").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("w").activate("c").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("w").activate("c").activate("s").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneNftMint = diagram("scene-nft-mint", { topic: "scene: NFT mint (wallet → contract → NFT)" })
  ...
  .node("n", { lane: "l", stack: 2, kind: "shape-nft", value: "{進み}%", title: "Rare Punk", eyebrow: "nft", subtitle: "#42" })
  .edge("w", "c", { label: "" })
  .edge("c", "n", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("w").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("w").activate("c").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("w").activate("c").activate("n").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneTokenBridge = diagram("scene-token-bridge", { topic: "scene: token bridge (chain A → bridge → chain B)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-blockchain", value: "{進み}%", title: "Arbitrum", eyebrow: "dst chain", subtitle: "L2" })
  .edge("a", "b", { label: "" })
  .edge("b", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("a").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("a").activate("b").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("a").activate("b").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneDefiLending = diagram("scene-defi-lending", { topic: "scene: DeFi lending (wallet → contract → token)" })
  ...
  .node("t", { lane: "l", stack: 2, kind: "shape-token", value: "{進み}%", title: "aUSDC", eyebrow: "token", subtitle: "yield-bearing" })
  .edge("w", "c", { label: "" })
  .edge("c", "t", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("w").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("w").activate("c").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("w").activate("c").activate("t").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneBitcoinTx = diagram("scene-bitcoin-tx", { topic: "scene: bitcoin tx (wallet → BTC chain → node)" })
  ...
  .node("n", { lane: "l", stack: 2, kind: "shape-blockchain-node", value: "{進み}%", title: "full node", eyebrow: "node", subtitle: "validator" })
  .edge("w", "c", { label: "" })
  .edge("c", "n", { label: "" })
...
export const sceneEcOrder = diagram("scene-ec-order", { topic: "scene: EC 注文 (customer → shop → warehouse)" })
  ...
  .node("w", { lane: "l", stack: 2, kind: "shape-warehouse", value: "{進み}%", title: "物流倉庫", eyebrow: "warehouse", subtitle: "出荷" })
  .edge("c", "s", { label: "" })
  .edge("s", "w", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("c").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("c").activate("s").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("c").activate("s").activate("w").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneMobileApi = diagram("scene-mobile-api", { topic: "scene: mobile app (mobile → API gateway → server)" })
  ...
  .node("s", { lane: "l", stack: 2, kind: "shape-server-rack", value: "{進み}%", title: "backend", eyebrow: "server", subtitle: "K8s" })
  .edge("m", "g", { label: "" })
  .edge("g", "s", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("m").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("m").activate("g").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("m").activate("g").activate("s").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneFactoryLine = diagram("scene-factory-line", { topic: "scene: 工場ライン (robot → sensor → DB)" })
  ...
  .node("d", { lane: "l", stack: 2, kind: "shape-cylinder", value: "{進み}%", title: "MES DB", eyebrow: "database", subtitle: "traceability" })
  .edge("r", "s", { label: "" })
  .edge("s", "d", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("r").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("r").activate("s").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("r").activate("s").activate("d").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneSatelliteChain = diagram("scene-satellite-chain", { topic: "scene: satellite (satellite → RPC → chain)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-blockchain", value: "{進み}%", title: "Solana", eyebrow: "chain", subtitle: "high TPS" })
  .edge("s", "r", { label: "" })
  .edge("r", "c", { label: "" })
...
export const sceneDevOps = diagram("scene-devops", { topic: "scene: DevOps (code → CI → cloud)" })
  ...
  .node("d", { lane: "l", stack: 2, kind: "shape-cloud", value: "{進み}%", title: "AWS ECS", eyebrow: "deploy", subtitle: "container" })
  .edge("c", "g", { label: "" })
  .edge("g", "d", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("c").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("c").activate("g").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("c").activate("g").activate("d").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneTaskFlow = diagram("scene-task-flow", { topic: "scene: task flow (kanban → terminal → file)" })
  ...
  .node("f", { lane: "l", stack: 2, kind: "shape-file", value: "{進み}%", title: "build.log", eyebrow: "file", subtitle: "output" })
  .edge("k", "t", { label: "" })
  .edge("t", "f", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("k").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("k").activate("t").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("k").activate("t").activate("f").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneNotification = diagram("scene-notification", { topic: "scene: 通知 (message → service → app)" })
  ...
  .node("w", { lane: "l", stack: 2, kind: "shape-window", value: "{進み}%", title: "デスクトップ通知", eyebrow: "window", subtitle: "OS native" })
  .edge("m", "h", { label: "" })
  .edge("h", "w", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("m").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("m").activate("h").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("m").activate("h").activate("w").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneTrustAsset = diagram("scene-trust-asset", { topic: "scene: 信託資産 (trader → trust bank → 帳簿)" })
  ...
  .node("f", { lane: "l", stack: 2, kind: "shape-file", value: "{進み}%", title: "運用報告書", eyebrow: "record", subtitle: "月次" })
  .edge("t", "b", { label: "" })
  .edge("b", "f", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("t").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("t").activate("b").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("t").activate("b").activate("f").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneConsensus = diagram("scene-consensus", { topic: "scene: consensus (node → block → chain)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-blockchain", value: "{進み}%", title: "canonical chain", eyebrow: "chain", subtitle: "finalized" })
  .edge("n", "b", { label: "" })
  .edge("b", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("n").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("n").activate("b").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("n").activate("b").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneTokenDeploy = diagram("scene-token-deploy", { topic: "scene: token deploy (dev → contract → token)" })
  ...
  .node("t", { lane: "l", stack: 2, kind: "shape-token", value: "{進み}%", title: "$KIWA", eyebrow: "token", subtitle: "1B supply" })
  .edge("d", "c", { label: "" })
  .edge("c", "t", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("d").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("d").activate("c").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("d").activate("c").activate("t").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneCompliance = diagram("scene-compliance", { topic: "scene: 規制対応 (regulator → 帳簿 → bank)" })
  ...
  .node("b", { lane: "l", stack: 2, kind: "shape-bank", value: "{進み}%", title: "対象銀行", eyebrow: "bank", subtitle: "検査対象" })
  .edge("r", "f", { label: "" })
  .edge("f", "b", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("r").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("r").activate("f").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("r").activate("f").activate("b").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneNftMarketplace = diagram("scene-nft-marketplace", { topic: "scene: NFT 売買 (buyer → marketplace → NFT)" })
  ...
  .node("n", { lane: "l", stack: 2, kind: "shape-nft", value: "{進み}%", title: "BAYC #7890", eyebrow: "nft", subtitle: "Bored Ape", w: 272 })
  .edge("b", "m", { label: "" })
  .edge("m", "n", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("b").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("b").activate("m").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("b").activate("m").activate("n").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneNetworkPath = diagram("scene-network-path", { topic: "scene: network (router → hub → server)" })
  ...
  .node("s", { lane: "l", stack: 2, kind: "shape-server-rack", value: "{進み}%", title: "app server", eyebrow: "server", subtitle: "DC", w: 272 })
  .edge("m", "n", { label: "" })
  .edge("n", "s", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("m").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("m").activate("n").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("m").activate("n").activate("s").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneCheckout = diagram("scene-checkout", { topic: "scene: checkout (site → provider → card)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-credit-card", value: "{進み}%", title: "MasterCard", eyebrow: "card", subtitle: "credit" })
  .edge("w", "p", { label: "" })
  .edge("p", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("w").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("w").activate("p").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("w").activate("p").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneEdgeCompute = diagram("scene-edge-compute", { topic: "scene: edge compute (mobile → CDN → cloud)" })
  ...
  .node("c", { lane: "l", stack: 2, kind: "shape-cloud", value: "{進み}%", title: "GCP origin", eyebrow: "cloud", subtitle: "fallback" })
  .edge("m", "e", { label: "" })
  .edge("e", "c", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("m").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("m").activate("e").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("m").activate("e").activate("c").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneVersionDeploy = diagram("scene-version-deploy", { topic: "scene: version deploy (stack → gear → site)" })
  ...
  .node("w", { lane: "l", stack: 2, kind: "shape-website", value: "{進み}%", title: "prod.example.com", eyebrow: "site", subtitle: "live", w: 404 })
  .edge("s", "g", { label: "" })
  .edge("g", "w", { label: "" })
  ...
  .phase("p2", { duration: 1200, title: "① 起点", body: "1 つ目が動き出す。" }, (p: PhaseBuilder) => p.activate("s").tween("進み", 0, 33).badge("①"))
  .phase("p3", { duration: 1200, title: "② 中継", body: "2 つ目へ渡る。" }, (p: PhaseBuilder) => p.activate("s").activate("g").tween("進み", 33, 66).badge("②"))
  .phase("p4", { duration: 1400, title: "③ 到達", body: "3 つ目に届いて完了する。" }, (p: PhaseBuilder) => p.activate("s").activate("g").activate("w").tween("進み", 66, 100).badge("③"))
  .build();
...
export const sceneAuditChain = diagram("scene-audit-chain", { topic: "scene: audit chain (auditor → file → regulator)" })
  ...
  .node("r", { lane: "l", stack: 2, kind: "shape-regulator", value: "{進み}%", title: "金融庁", eyebrow: "regulator", subtitle: "受領" })
  .edge("a", "f", { label: "" })
  .edge("f", "r", { label: "" })
