...
意匠帳が線の手当てを決めた図を、カタログの テキスト記法 の頁に載せてある。
...
![カタログの 8 表 8 関係、明るい側](images/mesh-catalog-light.png)
...
同じカタログの時系列のやり取りの図が日本語なので、ER 図だけ語が混ざるのを避ける。
